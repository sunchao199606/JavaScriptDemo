    ...
    b.prototype = {
        _init: function () {
            ...
            e._moQmTab = c = new qmTab({
                win: h, tab: f, style: { normal: "tab_list bd pointer", over: "tab_list bd pointer", select: "tab_list bd actived" }, onchange: function (l, k) {
                        ...
                        if (g = j[e].getAttribute(f)) {
                            j[e].onclick = function () {
                                ...
                                if (i.getAttribute(h) == "1") {
                                    ...
                                    i.setAttribute(h, "1");
                                    audioPlay({
                                        id: "weixin", global: false, autoplay: true, url: i.getAttribute(f), updatecallback: function (l) {
                                            var k = GelTags("img", i);
                                            if (l == "stopped") {
                                                show(k[1], 0);
                                                show(k[0], 1);
