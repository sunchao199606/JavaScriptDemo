...
function isSupportSSnap(a) {
    ...
    if (b.gbIsChrome && parseInt(gsChromeVer) > 41) {
        if ((b.gbIsMac || b.gbIsEdge) && a) {
            ...
            b.confirmBox({
                title: "\u6E29\u99A8\u63D0\u793A", msg: ['<div class="dialog_f_t" style="font-weight: normal;">\u4F60\u6B63\u5728\u4F7F\u7528\u7684\u662F', c, '\uFF0C\u6682\u4E0D\u652F\u6301\u622A\u5C4F\u529F\u80FD\u3002<br/>\u62B1\u6B49\u7ED9\u4F60\u5E26\u6765\u4E86\u56F0\u6270\uFF0C\u6211\u4EEC\u5C06\u5C3D\u5FEB\u4F18\u5316\u3002', d, '</div>'].join(""), confirmBtnTxt: '\u786E\u5B9A', mode: "alert", onreturn: function (e) {
                }
            });
...
function rollback(a) {
    ...
    if (b && b.rbkey) {
        confirmBox({
            title: "\u64A4\u9500\u786E\u8BA4", mode: "prompt", height: 135, msg: T(['\u64A4\u9500\u6700\u8FD1\u4E00\u6B21$msg$\u5417\uFF1F']).replace(b), onreturn: function (c) {
                if (c) {
                    QMAjax.send("/cgi-bin/mail_mgr", {
                        method: "POST", content: ["sid=", getSid(), "&mailaction=mail_revert&t=mail_mgr2&timekey=", b.rbkey, "&logtype=", a].join(''), onload: function (d, e) {
...
if (!getTop().goUserInfo) {
    getTop().goUserInfo = {
        _sStatus: 'init', _fCallbacks: {}, _oData: {}, isLoaded: function () {
            ...
            QMAjax.send(c, {
                method: "GET", timeout: 10000, headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, onload: function (d, e) {
...
function openComposeDlg(c, b, a) {
    ...
    loadingBox({
        model: "\u53D1\u4FE1", js: ["$js_path$libcompose3e5857.js", "$js_path$qmaddrinput24e6ae.js"], oncheck: function () {
...
function emptyFolder(a, b, c) {
    confirmBox({
        title: "\u6E05\u7A7A\u6587\u4EF6\u5939", msg: T(['<div class="dialog_f_t">$name$</div>', '<div class="dialog_f_d">\u6E05\u7A7A\u540E\u90AE\u4EF6\u5C06\u65E0\u6CD5\u6062\u590D\u3002</div>']).replace({ name: (c ? "\u662F\u5426\u8981\u6E05\u7A7A\u6B64\u6587\u4EF6\u5939\u4E2D\u7684\u90AE\u4EF6\uFF1F" : "\u662F\u5426\u8981\u6E05\u7A7A" + c + "\u4E2D\u7684\u90AE\u4EF6") }), confirmBtnTxt: '\u662F', cancelBtnTxt: '\u5426', onreturn: function (d) {
            d && b();
        }
    });
}
...
function openFullSelect(a) {
    var b = getTop();
    QMAjax.send(T('/cgi-bin/do?action=openfullsearch&sid=$sid$&r=$r$&t=$t$').replace({ sid: getSid(), r: Math.random(), t: "open_fullsearch.json" }), {
        method: "GET", headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, onload: function (c, d) {
            if (c) {
...
function fakeReadmail(a) {
    QMAjax.send(T('/cgi-bin/readmail?sid=$sid$&mailid=$mailid$&t=readsubmail&mode=fake&base=$base$&pf=$pf$').replace({ sid: getSid(), mailid: a.sMailId, pf: rdVer.isPre(a.sFolderId) ? 1 : 0, base: rdVer("BaseVer", 0) }), {
        method: "GET", headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, onload: function (b, c) {
            var f = trim2(c);
            if (b && f.indexOf("(") == 0) {
                var e = evalValue(f);
                if (e) {
...
function reportSpam(c, b, e, d, a) {
    ...
    new (getTop().QMDialog)({
        sId: "reportSpam", sTitle: d === 1 ? "\u7838\u6389\u8FD9\u4E2A\u74F6\u5B50" : "\u4E3E\u62A5\u5E76\u62D2\u6536\u9009\u4E2D\u90AE\u4EF6", sBodyHtml: o, nWidth: 450, nHeight: d === 1 ? 150 : 220, onload: function () {
            var q = this;
...
function doReject(b, a, d, c, e) {
    ...
    confirmBox({
        title: "\u62D2\u6536\u786E\u8BA4", msg: e || "\u62D2\u6536\u540E\u60A8\u5C06\u4E0D\u518D\u6536\u5230\u6765\u81EA\u6B64\u5730\u5740\u7684\u90AE\u4EF6\uFF0C\u786E\u8BA4\u62D2\u6536\u5417\uFF1F", confirmBtnTxt: "\u62D2\u6536", cancelBtnTxt: "\u53D6\u6D88", confirmClass: "btn_blue", onreturn: function (h) {
            if (h) {
...
function telphonePushWizard(a) {
    var b = getTop(), c = a;
    confirmBox({
        title: "\u62E8\u53F7\u786E\u8BA4", msg: T(['<div class="dialog_f_t">\u901A\u8FC7QQ\u90AE\u7BB1\u624B\u673A\u5BA2\u6237\u7AEF\u8FDB\u884C\u62E8\u53F7\uFF1A$telphonenumb$\uFF1F</div>', '<div class="dialog_f_d">\uFF08\u6B64\u529F\u80FD\u9700\u8981QQ\u90AE\u7BB1\u624B\u673A\u5BA2\u6237\u7AEF4.0\u7248\u672C\u53CA\u4EE5\u4E0A\u914D\u5408\u4F7F\u7528\uFF0C</br>\u672A\u5B89\u88C54.0\u7248\u672C\uFF0C\u8BF7<a href="http://app.mail.qq.com/" target="_blank" style="color:rgba(25, 99, 255, 1);">\u70B9\u6B64\u4E0B\u8F7D</a>\uFF09</div>']).replace({ telphonenumb: c }), confirmBtnTxt: '\u786E\u5B9A', cancelBtnTxt: '\u53D6\u6D88', onreturn: function (d) {
            if (d) {
                b.QMAjax.send("/cgi-bin/webapnscheck", {
                    content: b.T("sid=$sid$&key=$key$&action=pushphoneno&phoneno=$phoneno$").replace({ sid: b.getSid(), key: "", phoneno: encodeURIComponent(c) }), method: "POST", onload: function () {
                        confirmBox({
                            title: "\u65B0\u6D88\u606F\u63D0\u9192\u5DF2\u53D1\u51FA", msg: ['<div class="dialog_f_t">\u624B\u673A\u7AEF\u4F1A\u6536\u5230\u65B0\u6D88\u606F\u63D0\u9192\uFF0C\u8BF7\u70B9\u51FB\u65B0\u6D88\u606F\u901A\u77E5\u5F00\u59CB\u62E8\u53F7</div>', '<div class="dialog_f_d">\uFF08\u82E5\u957F\u65F6\u95F4\u672A\u6536\u5230\u65B0\u6D88\u606F\u901A\u77E5\uFF0C\u8BF7\u68C0\u67E5\u662F\u5426\u6709\u5F00\u542F\u624B\u673A\u7CFB\u7EDF\u901A</br>\u77E5\u6216\u5C1D\u8BD5\u91CD\u65B0\u62E8\u53F7\uFF09</div>'].join(""), onload: function () {
...
function _openExtLink(a, b, c) {
    ...
    if (a.href.indexOf("mailto:") == 0 && a.href.indexOf("@") != -1) {
        ...
        K = trim2(K);
        QMAjax.send(K, {
            method: "POST", content: "sid=" + getSid(), onload: function (e, R) {
                if (e) {
        ...
        function P() {
            ...
            QMAjax.send("/cgi-bin/gen_safecode", {
                method: "POST", content: ["t=apple_id_verify.json&mailid=", encodeURIComponent(z), "&type=", encodeURIComponent(I)].join(""), onload: function (e, R) {
                    var U = evalValue(R || "{}");
                    if (e && U && U.resCode == "0") {
                        showInfo("\u9A8C\u8BC1\u7801\u5DF2\u53D1\u9001");
                    }
        ...
        function L() {
            ...
            QMAjax.send("/cgi-bin/gen_safecode", {
                method: "POST", content: ["type=appleid_check&t=apple_id_verify.json&mailid=", encodeURIComponent(z), "&safecode=", encodeURIComponent(e)].join(""), onload: function (U, V) {
                    var W = evalValue(V || "{}");
                    if (U && W && W.resCode == "0") {
                        showInfo("\u9A8C\u8BC1\u901A\u8FC7\uFF0C\u8BFB\u4FE1\u4E2D...");
                        g.close();
        ...
        openComposeDlg("card", {
            sTitle: "\u7B54\u8C22\u597D\u53CB", sDefAddrs: u, bAddrEdit: true, nWidth: 495, sDefContent: N, bContentEdit: true, sDefSubject: "\u8C22\u8C22\u4F60\u7684\u8D3A\u5361!", bRichEditor: false, oncomplete: function () {
            }, bShowResult: true
        });
        return false;
    }
        ...
        var u = a.name;
        openComposeDlg("card", {
            sTitle: "\u7B54\u8C22\u597D\u53CB", sDefAddrs: u, bAddrEdit: true, nWidth: 495, sDefContent: "\u8C22\u8C22\u4F60\u7684\u8D3A\u5361\uFF01 \u4EE5\u540E\u8981\u5E38\u8054\u7CFB\u54E6\u3002", bContentEdit: true, sDefSubject: "\u8C22\u8C22\u4F60\u7684\u8D3A\u5361!", bRichEditor: false, oncomplete: function () {
            }, bShowResult: true
        });
        return false;
    }
        ...
        openComposeDlg("postcard", {
            sTitle: "\u7B54\u8C22\u597D\u53CB", sDefAddrs: u, bAddrEdit: true, nWidth: 495, sDefContent: "\u8C22\u8C22\u4F60\u7684\u660E\u4FE1\u7247\uFF01 \u4EE5\u540E\u8981\u5E38\u8054\u7CFB\u54E6\u3002", bContentEdit: true, sDefSubject: "\u8C22\u8C22\u4F60\u7684\u660E\u4FE1\u7247!", bRichEditor: false, oncomplete: function () {
            }, bShowResult: true
        });
        return false;
    }
        ...
        if (C.indexOf("follow=1") >= 0) {
            ...
            QMAjax.send(K, {
                method: "POST", content: "fun=followshare&followuin=" + w + "&sid=" + getSid(), onload: function (e, R) {
                    if (e) {
        ...
        if (!m.getAttribute(l)) {
            ...
            addEvents(m, {
                click: function (n) {
                    ...
                    new (getTop().QMMenu)({
                        sId: r, oEmbedWin: a, nWidth: p, nX: q[1] - p, nY: bodyScroll(a, "scrollHeight") - q[2] < o ? (q[0] - o - 13) : q[2], bAutoClose: false, oItems: [{ nHeight: o, sItemValue: MLJump._oTemplate.replace({ id: r }) }], onshow: function () {
                            this.S("txt").focus();
                        }
                    });
...
function initDropML() {
    ...
    a.delGroup(n);
    var j = null, c = false, l = null, g = null, e = null, m = /^([489]|personal|pop|tag)$/, i = new a.DropTarget(S('OutFolder'), {
...
function showSimpleRuleFilter(_asAddr) {
    ...
    var _oDialog = new (getTop().QMDialog)({
        sId: "addnewfilter_qqmail", sTitle: "\u5FEB\u6377\u521B\u5EFA\u6536\u4FE1\u89C4\u5219", sUrl: T("/cgi-bin/setting2?sid=$sid$&Fun=GetFolderList&CurFilterID=0&t=readmail_filter&fromaddr=$fromaddr$").replace({ sid: getSid(), fromaddr: _asAddr }), nWidth: 420, nHeight: 240, onshow: function () {
            ...
            waitFor(function () {
                ...
                if (_abIsOk) {
                    ...
                    ; function _fCreateFolder() {
                        promptFolder({
                            type: 'folder', bAlignCenter: true, width: 410, height: 237, style: "createNewFolder", onreturn: function (_asName) {
                                QMAjax.send("/cgi-bin/foldermgr", {
                                    method: "POST", content: ["sid=", getSid(), "&fun=new&from=simple&ef=js&resp_charset=UTF8&name=", _asName].join(''), onload: function (_abIsOk, _asResp) {
                                        try {
                                            if (_abIsOk) {
                    ...
                    _oQMSelect = new QMSelect({
                        oContainer: S("selectfolder", _oDialogWin), oMenu: { nWidth: "auto", nMaxWidth: 180, nMaxItemView: 4, oItems: _oUserFolder }, onselect: function (_aoItem) {
                            if (_aoItem.sId == "new") {
                                _fCreateFolder();
                                return true;
                            }
                    ...
                    addEvent(S("confirm", _oDialogWin), "click", function () {
                        ...
                        if (_sFolderId == "-1") {
                            ...
                            QMAjax.send("/cgi-bin/foldermgr", {
                                method: "POST", content: ["sid=", getSid(), "&fun=addfilter&from=simple&ef=js&action=move&oldmail=", _nOldMail, "&sender=", _asAddr, "&folderid=", _sFolderId].join(''), onload: function (_abIsOk, _asResp) {
                                    try {
                                        if (_abIsOk) {
                                            var _oData = eval("(" + _asResp + ")");
                                            if (_oData.errcode == "0") {
...
function applyRules(a) {
    confirmBox({
        title: "\u6536\u4FE1\u89C4\u5219", msg: "\u60A8\u662F\u5426\u8981\u5BF9\u6536\u4EF6\u7BB1\u7684\u5DF2\u6709\u90AE\u4EF6\u6267\u884C\u6B64\u89C4\u5219?", confirmBtnTxt: '\u662F', cancelBtnTxt: '\u5426', onreturn: function (b) {
            if (b) {
                applyRulesConfirm(a);
            }
            else {
...
function applyRulesConfirm(a) {
    QMAjax.send("/cgi-bin/mail_mgr", {
        method: "POST", content: ["sid=", getSid(), "&fname=&mailaction=mail_filter"].join(''), headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, onload: function (b, c) {
            if (b) {
...
function createBlankIframe(b, a) {
    cacheByIframe(a && a.defcss == false ? [] : [["css", "", getRes("$css_path$comm3b56cc.css")], ["css", getPath("style"), "skin"]], extend({ className: "menu_base_if", transparent: false, destroy: false }, a, {
        win: b, header: ["<script>", getTop.toString().replace(/[\r\n]/g, ""), "<\/script>", a && a.header || ""].join(""), onload: function (c) {
...
function loadingBox(a) {
    if (!callBack(a.oncheck)) {
        var b = new QMDialog({
            sId: "LoAdINgBOx", sTitle: a.model + "\u6A21\u5757\u52A0\u8F7D\u4E2D...", nWidth: 400, nHeight: 187, sBodyHtml: T(['<div style="text-align:center;padding:58px; padding-bottom:78px;">', '<img id="load" src="$images_path$ico_loading21e9c5d.gif">', '<span id="err" style="display:none;">$model$\u6A21\u5757\u52A0\u8F7D\u5931\u8D25</span>', '</div>']).replace(extend(a, { images_path: getPath("image") })), onclose: function () {
                b = null;
            }
        });
        if (a.js) {
...
function getAttachList(_avParam, _afCallback, _aoOption) {
    ...
    QMAjax.send(T("/cgi-bin/readmail?sid=$sid$&t=$t$&s=forward&from=attachfolder&disptype=html&ef=js$param$").replace({ sid: getSid(), t: "compose.json", param: _oParam.join('&mailattach=') }), {
...
function recallConfirm(c, b, a) {
    getTop().confirmBox({
        style: 'recall_cfm', confirmBtnTxt: '\u786E\u5B9A', cancelBtnTxt: '\u53D6\u6D88', mode: 'prompt', defaultChecked: true, title: "\u64A4\u56DE\u90AE\u4EF6", msg: ['<div class="dialog_f_t">\u786E\u5B9A\u64A4\u56DE\u6B64\u90AE\u4EF6\u5417\uFF1F</div>', '<div class="dialog_f_d">\u5982\u679C\u64A4\u56DE\u6210\u529F\uFF0C\u5BF9\u65B9\u5C06\u53EA\u80FD\u770B\u5230\u90AE\u4EF6\u7684\u4E3B\u9898\uFF0C\u5E76\u5F97\u5230\u5DF2\u88AB\u64A4\u56DE\u7684\u63D0\u793A\u3002</div>', '<div class="dialog_f_d graytext" style="margin:12px 0 0 -43px;">', '\u8BE6\u7EC6\u8BF4\u660E\uFF1A', '<ol style="list-style:decimal;padding:0;margin:0 0 0 2em;" >', '<li style="list-style: decimal inside none;">\u4EC5\u5C1D\u8BD5\u64A4\u56DE\u53D1\u5F80QQ\u90AE\u7BB1\u7684\u90AE\u4EF6\uFF0C\u4E0D\u652F\u6301\u4ECE\u5176\u4ED6\u90AE\u7BB1\u64A4\u56DE\u3002</li>', '<li style="list-style: decimal inside none;">\u5982\u679C\u5BF9\u65B9\u5DF2\u7ECF\u9605\u8BFB\uFF0C\u5C06\u4E0D\u4E88\u64A4\u56DE\u3002</li>', '<li style="list-style: decimal inside none;">\u64A4\u56DE\u7ED3\u679C\u5C06\u901A\u8FC7\u7CFB\u7EDF\u90AE\u4EF6\u901A\u77E5\u60A8\u3002 </li>', '</ol>', '</div>'].join(""), onreturn: function (d) {
            d && recall(c, b, a);
        }
    });
}
            ...
            getTop().mailRecall(1, { taskid: m.taskid, mailid: recall._msMailid, msgid: c }, {
                onbeforesend: function () {
                    ...
                    if (o.maildatacnt > 0) {
                        if (!d) {
                            new (getTop().QMDialog)({
                                sId: "query_recall_status_dlg", sTitle: "\u64A4\u56DE\u90AE\u4EF6", nWidth: 460, sBodyHtml: k.replace(o), onshow: function () {
                                    var p = this;
...
function bindAccount() {
    ...
    if (d) {
        ...
        d.parentNode.onclick = function () {
            ...
            new QMMenu({
                sId: "bindaccount", sClassName: "bindacc qmpanel_shadow", nX: g[3], nY: g[2], nWidth: 235, nMinWidth: 160, nItemHeight: 25, oItems: c, onitemclick: function (i, h) {
                    if (h._sType == 'bizmail') {
                        submitSwitchForm();
                    }
                    else {
                        var k = function (l) {
                            var n = getTop(), o = n.T(["https://xui.ptlogin2.qq.com/cgi-bin/xlogin?target=self&appid=522005705&daid=4", "&s_url=https://mail.qq.com/cgi-bin/readtemplate%3Ft%3Dqmptlogin_succ%26check%3Dfalse", "&proxy_url=https://mail.qq.com/proxy.html&need_qr=0&hide_border=1&border_radius=0&self_regurl=http://zc.qq.com/chs/index.html?type=1", "&app_id=11005&t=regist&pt_feedback_link=http://support.qq.com/discuss/350_1.shtml", "&hide_reg=1&hide_feedback=1&pt_lock_uin=1&default_uin=$uin$&pt_no_auth=1&enable_qlogin=0&low_login=0&style=40&no_verifyimg=1&pt_pwd=1"]).replace({ uin: h.email }), m = new n.QMDialog({
                                sId: "RelataPtlogin", sTitle: "\u5BC6\u7801\u9A8C\u8BC1", nWidth: 440, nMinWidth: 440, nHeight: 341, sUrl: o, onshow: function () {
                                }
                            });
                    ...
                    addEvent(i.S("bind"), 'click', function (k) {
                        ...
                        getTop().confirmBox({
                            title: "\u63D0\u793A", msg: ['<div class="dialog_f_t" style="font-weight: normal;">\u8BF7\u5728\u6253\u5F00\u7684\u7A97\u53E3\u4E2D\u5B8C\u6210\u65B0\u90AE\u7BB1\u6CE8\u518C\uFF0C\u6210\u529F\u6CE8\u518C<br/>\u540E\u53EF\u4EE5\u8FDB\u884C\u5907\u7528\u90AE\u7BB1\u7684\u8BBE\u7F6E</div>'].join(""), confirmBtnTxt: '\u5DF2\u6CE8\u518C', cancelBtnTxt: '\u53D6\u6D88', onreturn: function (l) {
                                l && toBindAccountPage();
                            }
                        });
                    });
...
function bindLinkedInAccount() {
    ...
    a._oDialog = new b.QMDialog({
        sId: "id_bindLinkedIn", sTitle: "\u7ED1\u5B9ALinkedIn\u5E10\u53F7", nWidth: 400, sBodyHtml: a._oTmpl.replace({}), bAnimation: false, onload: function () {
            var c = this;
...
function showTwoDCodeImgMenu(b, a, d, c) {
    ...
    new QMMenu({
        oEmbedWin: b, sId: "scanImg", bAutoClose: false, sWidthDetect: "float", nWidth: "auto", nX: j[3] + 25, nY: h, onshow: function () {
            if (gnIEVer == 6) {
...
var weworkSignature = (function () {
    ...
    function p(x) {
        ...
        if (e.gbIsIE) {
            e.confirmBox({
                title: "QQ\u90AE\u7BB1\u4F01\u4E1A\u540D\u7247", mode: "prompt", msg: '\u662F\u5426\u5B8C\u6210QQ\u90AE\u7BB1\u4F01\u4E1A\u540D\u7247\u7684\u7ED1\u5B9A\uFF1F', confirmBtnTxt: '\u5DF2\u7ED1\u5B9A', cancelBtnTxt: '\u53D6\u6D88', onreturn: function (C) {
                    switch (x) {
                        case 'compose':
                            u();
                            break;
        ...
        b = new (e.QMDialog)({
            sId: 'weworkSignature_dlg', sTitle: 'QQ\u90AE\u7BB1\u4F01\u4E1A\u540D\u7247', sUrl: B, nWidth: 340, nHeight: 470, bFrameScrolling: true, onbeforeclose: function () {
                b = null;
    ...
    function n(x) {
        ...
        g = 'wait';
        e.QMAjax.send("/cgi-bin/get_buss_card?resp_charset=UTF8&sid=" + e.getSid(), {
            method: "GET", onload: function (z, B) {
                g = 'init';
                var C;
                if (!z) {
    ...
    function k(y, z, x) {
        ...
        if (B.length) {
            e.QMAjax.send("/cgi-bin/get_buss_card?resp_charset=UTF8&sid=" + e.getSid() + "&func=getfriendbusscard&mailid=" + z + "&" + B.join('&'), {
                method: "GET", onload: function (D, G) {
                    var H = e.evalValue(G);
    ...
    function h(x) {
        ...
        y.QMAjax.send("/cgi-bin/get_buss_card?resp_charset=UTF8&func=addr_batch&sid=" + y.getSid(), {
            method: 'POST', content: z.join('&'), onload: function (C, D) {
                if (!C) {
                    return;
                }
                var H = y.evalValue(D);
    ...
    function q(x, y) {
        ...
        switch (y) {
            case 'today:main':
                e.QMAjax.send("/cgi-bin/do", {
                    content: "action=setbitmap&key=wework_signature_today_main&value=1", method: "POST", onload: function (C) {
                    }
                });
                break;
            case 'compose':
    ...
    function s() {
        e.confirmBox({
            title: "\u5173\u95ED\u6211\u7684\u5546\u52A1\u7B7E\u540D", mode: "prompt", msg: '\u5173\u95ED\u540E\uFF0C\u5546\u52A1\u7B7E\u540D\u5C06\u5931\u6548\uFF0C\u662F\u5426\u5173\u95ED\u5546\u52A1\u7B7E\u540D\uFF1F', onreturn: function (x) {
                if (x) {
                    e.QMAjax.send("/cgi-bin/get_buss_card?resp_charset=UTF8&func=unbind_card&sid=" + e.getSid(), {
                        method: 'POST', onload: function (y, z) {
                            if (y) {
                                showInfo('\u5173\u95ED\u6210\u529F');
                            }
                            else {
    ...
    function r(x) {
        f = new (e.QMDialog)({
            sId: 'weworkSignatureUnbind_dlg', sTitle: 'QQ\u90AE\u7BB1\u4F01\u4E1A\u540D\u7247', sUrl: e.T('/cgi-bin/get_buss_card?sid=$sid$&t=get_buss_card_unbind&from=$from$').replace({ sid: e.getSid(), from: encodeURIComponent(x) }), nWidth: 340, nHeight: 470, bFrameScrolling: true, onbeforeclose: function () {
                f = null;
            }
        });
...
function toAddAccountPage() {
    ...
    a._oDialog = new b.QMDialog({
        sId: "id_AddAccount", sTitle: "\u6DFB\u52A0\u90AE\u7BB1\u5E10\u53F7", nWidth: 440, sBodyHtml: a._oTmpl.replace({ "step": "1" }), bAnimation: false, onshow: function () {
            var c = this;
...
getTop().extend(toAddAccountPage, _oOidbAccountBase, {
    _oTmpl: getTop().TE(['$@$if($step$=="1")$@$', '<div class="addAccount_step addAccount_step_Username">', '<div id="div_warning" class="addAccount_errorTip"></div>', '<div id="div_frame_container" class="addAccount_text">', '<div class="addAccount_label">\u6DFB\u52A0\u5E10\u53F7</div><input type="text" id="ipt_username" class="addAccount_ipt" value="$username$" onkeydown="getTop().toAddAccountPage.enterPress(event,\'1\');" onkeypress="getTop().toAddAccountPage.enterPress(event,\'1\');"/>', '</div>', '</div>', '$@$else if($step$=="2")$@$', '<div id="div_stepPassword" class="addAccount_step addAccount_step_Password">', '<div id="div_warning" class="addAccount_errorTip"></div>', '<div id="div_username" class="addAccount_step_usernameShow">$username$</div>', '$@$if($uInfo$=="qq")$@$', '<div class="addAccount_ptlogin">', '<iframe frameborder="0" width="100%" src="$ptloginurl$" id="importFrame" allowtransparency="true"></iframe>', '</div>', '$@$else$@$', '<div class="addAccount_login" id="div_addAccount_login">', '<div class="addAccount_text">', '<div class="addAccount_label">\u5BC6\u7801</div>', '<input type="password" class="addAccount_ipt" tabindex="2" id="ipt_pwd" onkeydown="getTop().toAddAccountPage.enterPress(event);" onkeypress="getTop().toAddAccountPage.enterPress(event);"/>', '<div id="capTip" class="qui_cntIndent_captip" style="display:none;"><span class="qui_cntIndent_captip_row"></span>\u5927\u5199\u9501\u5B9A\u5DF2\u6253\u5F00</div>', '</div>', '<div id="div_verifycode" style="display:none; padding-bottom:16px;">', '<div class="addAccount_label">\u9A8C\u8BC1\u7801</div>', '<input type="text" id="loginVerify" name="loginVerify" value="" class="addAccount_ipt" style="margin-bottom:5px;" onkeydown="getTop().toAddAccountPage.enterPress(event);" onkeypress="getTop().toAddAccountPage.enterPress(event);">', '<img id="verifyImage" src="" style="display:block;clear:both;margin-left:57px;border:1px solid #eee;"/>', '<input type="hidden" id="loginData" name="loginData" value="" />', '<input type="hidden" id="loginCookies" name="loginCookies" value="" />', '</div>', '<div id="div_challenge" style="display:none;padding-bottom:16px;">', '<div class="addAccount_label">\u8EAB\u4EFD\u9A8C\u8BC1</div>', '<input type="text" id="secondPin" name="secondPin" value="" class="addAccount_ipt" onkeydown="getTop().toAddAccountPage.enterPress(event);" onkeypress="getTop().toAddAccountPage.enterPress(event);">', '<input type="text" id="phoneNumber" name="phoneNumber" value="" style="display:none;" class="addAccount_ipt" onkeydown="getTop().toAddAccountPage.enterPress(event);" onkeypress="getTop().toAddAccountPage.enterPress(event);">', '<input type="text" id="verifySmsChallengeAnswer" name="VerifySmsChallengeAnswer" value="" class="addAccount_ipt" style="display:none;" onkeydown="getTop().toAddAccountPage.enterPress(event);" onkeypress="getTop().toAddAccountPage.enterPress(event);">', '<input type="text" id="androidTablet" name="androidTablet" value="" style="display:none;" class="addAccount_ipt" onkeydown="getTop().toAddAccountPage.enterPress(event);" onkeypress="getTop().toAddAccountPage.enterPress(event);">', '<input type="text" id="emailAnswer" name="emailAnswer" value="" style="display:none;" class="addAccount_ipt" onkeydown="getTop().toAddAccountPage.enterPress(event);" onkeypress="getTop().toAddAccountPage.enterPress(event);">', '<input type="text" id="deviceAddress" name="deviceAddress" value="" style="display:none;" class="addAccount_ipt" onkeydown="getTop().toAddAccountPage.enterPress(event);" onkeypress="getTop().toAddAccountPage.enterPress(event);">', '<input type="text" id="secretAnswer" name="secretAnswer" value="" style="display:none;" class="addAccount_ipt" onkeydown="getTop().toAddAccountPage.enterPress(event);" onkeypress="getTop().toAddAccountPage.enterPress(event);">', '<div id="challengeTip" style="font-size:12px;clear:both;color:#999;padding-top:5px;margin-left:57px;"></div>', '<input type="hidden" id="challengeData" name="challengeData" value="" />', '<input type="hidden" id="challengeCookies" name="challengeCookies" value="" />', '<input type="hidden" id="challengeAction" name="challengeAction" value="" />', '</div>', '<div id="div_popsvr" style="display:none">', '<div class="addAccount_text">', '<div class="addAccount_label">POP\u670D\u52A1\u5668\u5730\u5740</div>', '<input type="text" class="addAccount_ipt" tabindex="3" id="ipt_popserver" onkeydown="getTop().toAddAccountPage.enterPress(event)" onkeypress="getTop().toAddAccountPage.enterPress(event)"/>', '</div>', '<div class="addAccount_text" id="div_port">', '<div class="addAccount_label">POP\u670D\u52A1\u5668\u7AEF\u53E3</div>', '<input type="text" class="addAccount_ipt" tabindex="4" id="ipt_port" value="110" onkeydown="getTop().toAddAccountPage.enterPress(event)" onkeypress="getTop().toAddAccountPage.enterPress(event)"/>', '</div>', '<div class="addAccount_text" id="div_ssl" style="padding-left: 105px;margin-top: -15px;padding-bottom: 0px;">', '<input type="checkbox" name="ckb_ssl" id="ckb_ssl" class="ckb_ssl"><label for="ckb_ssl">\u5F00\u542FSSL\u5B89\u5168\u8FDE\u63A5</label>', '</div>', '</div>', '</div>', '$@$endif$@$', '</div>', '<div class="addAccount_loadingWrap" style="display: none;" id="div_loading">', '<span class="addAccount_loading"></span>', '</div>', '$@$else$@$', '<div class="addAccount_step_Finish">', '<div class="qui_clear addAccount_step_succeedTip"><span class="addAccount_step_succeedImg"></span><span class="addAccount_step_succeedDesc">\u606D\u559C\u4F60\u6210\u529F\u6DFB\u52A0\u4E86<span class="qui_txtBold">$username$</span></span></div>', '<ul class="addAccount_finishSetting">', '<li class="addAccount_finishSetting_item"><input class="addAccount_finishSetting_radio" type="radio" name="mailReceive" id="radio_7" value="7" checked/><label for="radio_7">\u6536\u53D6\u6700\u8FD17\u5929\u7684\u90AE\u4EF6</label></li>', '<li class="addAccount_finishSetting_item"><input class="addAccount_finishSetting_radio" type="radio" name="mailReceive" id="radio_all" value="all"/><label for="radio_all">\u6536\u53D6\u5168\u90E8\u90AE\u4EF6</label></li>', '<li class="addAccount_finishSetting_item"><input class="addAccount_finishSetting_radio" type="radio" name="mailReceive" id="radio_0" value="0"/><label for="radio_0">\u6682\u4E0D\u6536\u53D6\u6B64\u90AE\u7BB1\u90AE\u4EF6</label></li>', '</ul>', '</div>', '$@$endif$@$', '<div class="dialog_operate addAccount_foot" id="div_foot">', '<a href="javascript:;"  id="geConfirmBtn" class="qui_btn qui_btn_Blue">$@$if($step$=="1")$@$ \u4E0B\u4E00\u6B65 $@$else if($step$=="2")$@$ \u9A8C\u8BC1 $@$else$@$ \u67E5\u770B $@$endif$@$</a>', '<a href="javascript:;"  id="geCancelBtn" class="qui_btn addAccount_foot_cancel">$@$if($step$=="1")$@$ \u53D6\u6D88 $@$else if($step$=="2")$@$ \u4E0A\u4E00\u6B65 $@$else$@$ \u5B8C\u6210\u66F4\u591A\u8BBE\u7F6E $@$endif$@$</a>', '</div>']), getCssVer: function () {
        ...
        f.QMAjax.send(f.T("/cgi-bin/foldermgr?sid=#sid#&enter=new&fun=createpop&folderid=&acctid=0&step=&fromtips=&popmail=#popmail#&popfolder=#popmail#&popnickname=&popsvr=#popsvr#&popport=#popport#&timeflag=1&delflag=&isenddef=1&needspam=1&smtpneedpwd=0&showsmtppanel=0&agentsend=&smtpsvr=&smtpport=25&nosmtppwd=&smtppwd=&taskid=#taskid#&t=mailpotl.json", "#").replace({ sid: f.getSid(), popmail: encodeURIComponent(b._sPopmail), popsvr: encodeURIComponent(b._sPopsvr), popport: encodeURIComponent(b._sPopport), taskid: b._sTaskid || "" }), {
...
function toBindAccountPage() {
    ...
    a._oDialog = new b.QMDialog({
        sId: "id_bindAccount", sTitle: "\u5173\u8054\u5DF2\u6709\u90AE\u7BB1", nWidth: 440, sBodyHtml: a._oTmpl.replace({ "step": "1", "ptloginurl": c }), bAnimation: false, onload: function () {
            var d = this;
...
getTop().extend(toBindAccountPage, _oOidbAccountBase, {
    _oTmpl: getTop().TE(['$@$if($step$=="1")$@$', '<div id="div_frame_container" class="qui_dialogPtlogin">', '<div id="dialogPtloginTitle" class="qui_dialogPtlogin_title">', '<div class="qui_dialogPtlogin_label qui_dialogPtlogin_label_Uin">\u5173\u8054\u5E10\u53F7</div>', '<div class="qui_dialogPtlogin_label">\u5BC6\u7801</div>', '</div>', '<div id="importFrameWrap" class="qui_dialogPtlogin_cnt">', '<iframe frameborder="0" width="100%" src="$ptloginurl$" id="importFrame" allowtransparency="true"></iframe>', '</div>', '</div>', '<a href="javascript:;" id="geCancelBtn" class="qui_btn qui_dialogPtlogin_cancel">\u53D6\u6D88</a>', '$@$else if($step$=="2")$@$', '<div class="bindAccount_succeed">', '<div class="qui_clear bindAccount_succeed_tip">', '<span class="bindAccount_succeed_img"></span>', '<span class="bindAccount_succeed_desc">\u6210\u529F\u5173\u8054\u4E86<span class="qui_txtBold">$username$</span></span>', '</div>', '</div>', '<div class="dialog_operate" id="geFinishBtn_wrap">', '<a href="javascript:;" id="geFinishBtn" class="qui_btn">\u5B8C\u6210</a>', '</div>', '$@$else if($step$=="3")$@$', '$@$if($isExitBind$=="1")$@$', '<dd>', '<div>', '<span class="num">$username$</span>', '<a href="/cgi-bin/bind?fun=unbind&uin=$uin$&sid=$sid$" target="actionFrame">\u53D6\u6D88\u5173\u8054</a>', '</div>', '</dd>', '$@$else$@$', '<dl style="margin-bottom:8px;" id="dl_hasbinds">', '<dt style="margin:0;" class="f_size addrtitle">\u4F60\u5DF2\u5173\u8054\u7684\u5907\u7528\u90AE\u7BB1\uFF1A</dt>', '<dd>', '<div>', '<span class="num">$username$</span>', '<a href="/cgi-bin/bind?fun=unbind&uin=$uin$&sid=$sid$" target="actionFrame">\u53D6\u6D88\u5173\u8054</a>', '</div>', '</dd>', '<dl>', '$@$endif$@$', '$@$endif$@$']), getCssVer: function () {
        ...
        _oTop.QMAjax.send(_oTop.T(["/cgi-bin/bind?sid=$sid$&fromzc=&fun=bind&mailaddr=$mailaddr$&fromzc=&t=mailpotl.json", "&uin=$uin$&aliastype=$aliastype$&verifycode="]).replace({ "sid": a.sid, "mailaddr": a.sLoginaccount, "uin": a.uin, "aliastype": a.sAliasType }), {
...
function toAuthorizeWeiyun() {
    ...
    b.loadCssFile("$css_path$login/addAccount44a10d.css", true, b.document);
    a._oDialog = new b.QMDialog({
        sId: "id_AuthorizeWeiyun", sTitle: "\u6388\u6743\u5FAE\u4E91", nWidth: 440, sBodyHtml: a._oTmpl.replace({ "username": b.getUin(), "ptloginurl": a.getPtloginUrl({ "uin": b.getUin() }) }), bAnimation: false, onshow: function () {
            var c = this;
...
function toVerifyQQAccount(d, e) {
    ...
    a._oDialog = new c.QMDialog({
        sId: "id_VerifyAccount", sTitle: "\u8EAB\u4EFD\u9A8C\u8BC1", nWidth: 330, sClassName: "verifyAccount_dialog", sBodyHtml: a._oTmpl.replace({ "username": d, "ptloginurl": a.getPtloginUrl({ "uin": c.getUin() }) }), bAnimation: false, onshow: function () {
            var f = this;
...
getTop().extend(toVerifyQQAccount, _oOidbAccountBase, {
