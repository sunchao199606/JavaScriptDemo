...
_goClass._initElements = function (a) {
    ...
    for (var c in d) {
        ...
        g[c] = new qmSimpleThumb({
            id: c, win: a.win, imgpath: a.imgpath, numperPage: a.numperpage || 8, enabled: false, dom: { container: b.dom.container, prevbtn: a.dom.prevbtn, nextbtn: a.dom.nextbtn, pagetxt: a.dom.pagetxt }, style: { thumb: a.style.thumb, btn: a.style.btn }, data: b.data, onselect: function (h, j) {
...
var QMDialog = inheritEx("QMDialog", QMPanel, function (a) {
    return {
        initMemVar_: function (b) {
            ...
            new (QMDragDrop.Draggable)(e._moPanelDom, { handle: e.S("_head_"), maxcontainer: b.oEmbedWin.document.body }, {
                ondragstart: function () {
            ...
            if (d == "ani0") {
                ...
                if (b) {
                    l.play(r, {
                        win: window, speed: 300, easing: "easeOut", tween: "Sina", from: -30, to: 0, onready: function () {
                    ...
                    l.play(r, {
                        win: window, speed: 300, easing: "easeIn", tween: "Sina", from: 0, to: -30, onaction: function (v, u) {
...
QMSelect.prototype = {
    get: function (a) {
        ...
        c.configHelp_(a.oMenu, {
            oEmbedWin: c._moWin, sId: "select", nWidth: b.clientWidth + 3, nMinWidth: b.clientWidth + 3, onitemclick: function (e) {
                if (a.sName) {
...
_goClass._iniSender = function (a) {
    ...
    var k = 0, A = function (M, e) {
        ...
        var N = V.length > 17 ? 17 : V.length, W = new (getTop().QMMenu)({
            oEmbedWin: z._moWin, sId: "sendermenu", nMaxItemView: 17, nX: D == "left" ? X[3] : X[3] - (k - this.clientWidth), nY: J == "bottom" ? X[2] : (X[2] - 21 * N - 21), nMinWidth: 230, bAnimation: false, nItemHeight: 21, oItems: V, onitemclick: function (ac) {
                v[ac]();
            }, onshow: function () {
                if (!e) {
                    W.selectItem(P);
    ...
    return {
        $_constructor_: function (b) {
            ...
            e._moMenu = new QMAutoComplete._QMAutoCompleteMenu({
                sId: unikey(), oItems: [], supportKey: e._mbsupportKey, oEmbedWin: e._moWin, nWidth: b.nWidth || "auto", nMinWidth: b.nMinWidth || 100, nItemHeight: b.nItemHeight || 21, nMaxItemView: b.nMaxItemView || 0, type: b.type, nZIndex: b.nZIndex || 1121, sClassName: b.sClassName, oClass: b.oClass, bDisplay: false, onselect: function (f) {
...
function setMailRead(a, b) {
    ...
    if (f || c) {
        ...
        var F = a ? '\u8BBE\u7F6E\u672A\u8BFB' : '\u8BBE\u7F6E\u5DF2\u8BFB';
        AjaxSendMailMgr({
            oQuery: x, sSuccessMask: "new successful", sDefErrMsg: F + '\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (j, P, O) {
                N();
...
function pendingMail(a, c, b) {
    ...
    m.push('&status=' + a);
    AjaxSendMailMgr({
        oQuery: m, sSuccessMask: 'pending successful', sDefErrMsg: a ? '\u6807\u8BB0\u5F85\u529E\u72B6\u6001\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5' : '\u6807\u8BB0\u4E3A\u5DF2\u5B8C\u6210\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (p, r, q) {
...
; function starMail(a, b) {
    ...
    AjaxSendMailMgr({
        oQuery: n, sSuccessMask: 'star successful', sDefErrMsg: a ? '\u6807\u8BB0\u661F\u6807\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5' : '\u53D6\u6D88\u661F\u6807\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (s, u, t) {
...
function topMail(a, b) {
    ...
    e.push("&status=" + a);
    AjaxSendMailMgr({
        oQuery: e, sSuccessMask: "top successful", sDefErrMsg: a ? "\u6807\u8BB0\u7F6E\u9876\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5" : "\u53D6\u6D88\u7F6E\u9876\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5", onload: function (g, j, h) {
...
function moveMailJs(b, c, d, a) {
    ...
    var h = function () {
        ...
        AjaxSendMailMgr({
            oQuery: p, sSuccessMask: 'mail_move successful', sDefErrMsg: '\u79FB\u52A8\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (v, x, w) {
                var y, A;
                if (a.oWin[s]) {
                ...
                if (y) {
                    if (a == 2) {
                        ...
                        if (z && z.checked) {
                            ...
                            getTop().QMAjax.send(getTop().T("/cgi-bin/setting10?action=desubscribe&sid=$sid$$colidlist$").replace({ sid: w, colidlist: A }), {
...
function doRmMail(c, d, a, b) {
    ...
    if (c.bPop && getTop().goUserInfo.get("POP_PROPOSE")) {
        confirmBox({
            title: "\u90AE\u7BB1\u529F\u80FD\u63A8\u8350", mode: "prompt", msg: T(['<div class="dialog_f_t">\u5728$dn$\u90AE\u7BB1\u4E2D\u5220\u9664\u90AE\u4EF6\uFF0C\u540C\u65F6\u4E5F\u5220\u9664\u539F\u90AE\u7BB1\u4E2D\u7684\u5BF9\u5E94\u90AE\u4EF6?</div>', '<div class="dialog_f_d">', '\u60A8\u4E5F\u53EF\u4EE5\u8FDB\u5165\u201C\u4FEE\u6539\u8BBE\u7F6E\u201D\u4E2D\u8BBE\u7F6E\u3002', '<a href="http://service.mail.qq.com/cgi-bin/help?subtype=1&&id=26&&no=326" target="_blank" >\u4E86\u89E3\u8BE6\u8BF7</a>', '</div>']).replace({ dn: getDomain(true) }), onreturn: function (j) {
                if (j) {
    ...
    c.oWin[h] = 1;
    AjaxSendMailMgr({
        oQuery: d, sSuccessMask: 'mail_del successful', sDefErrMsg: '\u5220\u9664\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (j, l, k) {
...
reportSpamJson._doReportSpam = function (b, c, a) {
    ...
    gsSpamResultHtml = '';
    AjaxSendMailMgr({
        oQuery: b, sSuccessMask: 'spam successful', sDefErrMsg: '\u4E3E\u62A5\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (q, s, r) {
...
function reportNoSpamJson(b, a) {
    ...
    a.oWin[k] = 1;
    AjaxSendMailMgr({
        oQuery: h, sSuccessMask: 'spam successful', sDefErrMsg: '\u8BBE\u7F6E\u4E0D\u662F\u5783\u573E\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (m, o, n) {
...
function reportAdJson(b, a) {
    ...
    function l(o, p) {
        ...
        a.oWin[m] = 1;
        AjaxSendMailMgr({
            oQuery: h, sSuccessMask: 'ad successful', sDefErrMsg: b.bNotAd ? '\u6807\u8BB0\u975E\u5E7F\u544A\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5' : '\u6807\u8BB0\u5E7F\u544A\u90AE\u4EF6\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (s, u, t) {
    ...
    if (b.bShowConfirm) {
        reportAddrConfirm(a, {
            sTitle: '\u6807\u8BB0\u5E7F\u544A\u90AE\u4EF6', sTextTitle: b.bNotAd ? '\u4EE5\u4E0B\u5730\u5740\u53D1\u6765\u7684\u90AE\u4EF6\u5C06\u4E0D\u518D\u8FDB\u5165\u5E7F\u544A\u90AE\u4EF6\uFF0C\u786E\u5B9A\u6807\u8BB0\u5417\uFF1F' : '\u4EE5\u4E0B\u5730\u5740\u53D1\u6765\u7684\u90AE\u4EF6\u5C06\u4F1A\u81EA\u52A8\u79FB\u5165\u5E7F\u544A\u90AE\u4EF6\uFF0C\u786E\u5B9A\u6807\u8BB0\u5417\uFF1F', onreturn: function (o, p, r, q) {
                if (o) {
                    var s = [];
                    j.E(r, function (t) {
                        s.push(q[t]);
...
var setAdMailAllReaded = (function () {
    ...
    function d(j) {
        h.QMAjax.send('/cgi-bin/mail_mgr?sid=' + h.getSid(), {
            content: 'mailaction=mail_flag&flag=new&status=false&mailid=AC0000-00000000000000000000000&t=mail_mgr2&resp_charset=UTF8&ef=js&folderkey=1', onload: function () {
                h.QMMLCache.upVer();
                c(j, arguments);
            }
        });
...
QMTag.setMailTag = function (b, a) {
    ...
    if (h) {
        AjaxSendMailMgr({
            oQuery: p, sSuccessMask: 'mail_tag successful', sDefErrMsg: '\u8BBE\u7F6E\u6807\u7B7E\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (w, v, u) {
...
QMTag.newMailTag = function (a) {
    ...
    promptFolder({
        type: 'tag', onreturn: function (b) {
            ...
            AjaxSendMailMgr({
                oQuery: k, sSuccessMask: 'mail_tag successful', sDefErrMsg: '\u521B\u5EFA\u6807\u7B7E\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (p, n, m) {
                    showInfo("\u6807\u7B7E\u521B\u5EFA\u6210\u529F");
                    reloadLeftWin();
...
QMTag._autoTagOldMail = function (_asFilterId, _abMailList) {
    confirmBox({
        title: "\u6536\u4FE1\u89C4\u5219", msg: "\u5BF9\u4E8E\u6536\u4EF6\u7BB1\u4E2D\u7B26\u5408\u6761\u4EF6\u7684\u5DF2\u6709\u90AE\u4EF6\uFF0C\u60A8\u662F\u5426\u4E5F\u8981\u6807\u4E0A\u6B64\u6807\u7B7E\uFF1F", confirmBtnTxt: '\u662F', cancelBtnTxt: '\u5426', onreturn: function (_abIsOk) {
            if (_abIsOk) {
                AjaxSendMailMgr({
                    oQuery: ['&fun=AutoTag&mailaction=mail_filter&filterid=', _asFilterId], sSuccessMask: 'mail_tag successful', sDefErrMsg: '\u64CD\u4F5C\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (_oResult, _asParam, _aoXmlObj) {
...
QMTag.setMailAutoTag = function (a) {
    ...
    confirmBox({
        mode: "prompt", title: '\u65B0\u5EFA\u81EA\u52A8\u6807\u7B7E', sType: "custom", msg: ['<div style="padding:10px;">', '<div style="width:100%;margin:10px;"><b>\u5BF9\u4E8E\u53D1\u4EF6\u4EBA</b><input type="text" id="addr" style="width:300px;margin-left:54px;"/></div><div style="margin:10px;"><b>\u6765\u4FE1\u81EA\u52A8\u6807\u4E3A\u6807\u7B7E</b><input type="text" id="name" style="width:300px;margin-left:15px;"/></div>', '<div class="graytext" style="width:450px;margin:10px;">\u8BE5\u53D1\u4EF6\u5730\u5740\u7684\u6765\u4FE1\uFF0C\u4F1A\u81EA\u52A8\u52A0\u4E0A\u6807\u7B7E\uFF0C\u4FBF\u4E8E\u60A8\u8BC6\u522B\u548C\u7BA1\u7406\u90AE\u4EF6\u3002</div>', '</div>'].join(''), onload: function () {
            var g = this;
            ...
            AjaxSendMailMgr({
                sUrl: '/cgi-bin/setting2', oQuery: f, sSuccessMask: 'mail_tag successful', sDefErrMsg: '\u8BBE\u7F6E\u81EA\u52A8\u6807\u7B7E\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5', onload: function (p, n, m) {
...
QMTag.rmTag = function (b, a) {
    ...
    if (k) {
        AjaxSendMailMgr({
            oQuery: r, sSuccessMask: "mail_tag successful", sDefErrMsg: T(['\u79FB\u9664\u6807\u7B7E\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5']), onload: function (y, x, j) {
    ...
    function c(h, d, g, j, k, e, f) {
        ...
        if (h) {
            E(SN("selmContainer", j), function (n) {
                if (!n.innerHTML) {
                    new QMSelect({
                        oContainer: n, sDefaultItemValue: "\u79FB\u52A8\u5230...", sMenuType: "dropdown", oMenu: { nWidth: "auto", nMaxWidth: 180, nMinWidth: 90, bAutoItemView: true, bAutoClose: true, oItems: h }, onafteropenmenu: function (o, p) {
                            var q;
        ...
        E(SN("markContainer", j), function (n) {
            ...
            new QMSelect({
                oContainer: n, sMenuType: "dropdown", sDefaultItemValue: "\u6807\u8BB0\u4E3A...", oMenu: { nWidth: "auto", nMaxWidth: 180, bAutoItemView: true, bAutoClose: true, oItems: [] }, onselect: function (o) {
                    var p = this.get("menu");
                    l.apply(o.sId, o.sItemValue);
                    p.hide();
                    getTop().changeSelectAllCkbStatus();
...
(function (a, b) {
    ...
    k.prototype = {
        _oDefaults: { nMaxFileSize: 0, nMaxFileNum: 0, oFileTypes: null }, _oLangs: { FILENUM_OVERFLOW: '\u9009\u62E9\u7684\u6587\u4EF6\u8FC7\u591A', FILESIZE_OVERFLOW: '\u4E0A\u4F20\u6587\u4EF6\u8FC7\u5927', FILESIZE_ZERO: '\u4E0D\u80FD\u4E0A\u4F20\u7A7A\u6587\u4EF6', FILEINFO_ERROR: '\u6587\u4EF6\u8DEF\u5F84\u8BC6\u522B\u9519\u8BEF\u6216\u8D85\u51FA\u5927\u5C0F\u9650\u5236', SELECT_ERROR: '\u65E0\u6CD5\u8BFB\u53D6\u6587\u4EF6\u5185\u5BB9', NOTSUPPERTYPE: '\u4E0D\u652F\u6301\u7684\u6587\u4EF6\u7C7B\u578B' }, setConfig: function (l, m) {
            this._moCfg[l] = m;
...
(function () {
    QMFileAdaptor.extend(QMFileAdaptor, {
        getCookie: getCookie, getSid: getSid, getUin: getUin, ossLog: ossLog, QMAjax: QMAjax, htmlDecode: htmlDecode, gbIsIE: gbIsIE, gbIsFF: gbIsFF, gbIsWebKit: gbIsWebKit, speedNow: function () {
            return +new Date();
        }, LogKV: LogKV
    });
})();
        ...
        return ({
            defaultQueryData: function () {
                ...
                if (n) {
                    ...
                    o._mnKeepAlive = setInterval(function () {
                        a.QMAjax.send("/cgi-bin/readtemplate?t=keep_alive&ef=js&sid=" + a.getSid() + "&r=" + Math.random(), {
                            method: "GET", headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, onload: function (p, r, q) {
                ...
                ; a.QMAjax.send(['/cgi-bin/uploadunite?func=CreateFile&&inputf=json&outputf=json&&sid=', a.getSid()].join(""), {
                    method: 'post', headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, content: a.T('{"path":"$path$","appid":"$appid$","size":$size$}').replace({ appid: o, path: encodeURIComponent(n.get("sName")), size: n.get("nSize") }), onload: function (q, s, r) {
                ...
                a.QMAjax.send(['/cgi-bin/uploadunite?func=CheckFile&inputf=json&outputf=json&sid=', a.getSid()].join(""), {
                    method: 'post', headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, content: a.T('{"fileid":"$fileid$","data":"$data$","suffix":"$suffix$","md5":"$md5$","mailid":"$mailid$"}').replace({ fileid: n.get("sFileId"), data: o, suffix: q, md5: n.get("sMD5"), mailid: n.get("sMailId") }), onload: function (r, t, s) {
                        if (r) {
    ...
    g.getFtnLib = function (m) {
        return ({
            qmFile: l, oncompleteToFtn: function (n) {
                var o = this;
                if (n.get("bFtnFile")) {
                    a.QMAjax.send(a.T("/cgi-bin/ftnGetURL?sid=$sid$&t=ftn.json&s=part&fid=$fid$&ef=js").replace({ sid: a.getSid(), fid: n.get("sFileId") }), {
                ...
                a.QMAjax.send(a.T("/cgi-bin/ftnCreatefile?sid=$sid$&path=$path$&type=direct&s=comCreate&appid=$appid$&dirid=$dirid$&ef=js&resp_charset=UTF8&loc=$loc$").replace({ sid: a.getSid(), loc: ["ftnCreatefile", "ftnCreatefile", "comCreate", (n.get("sFrom") || "") + o].join(","), appid: o, dirid: n.get("sPathId") || "", path: encodeURIComponent(n.get("sName")) }), {
                    headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, onload: function (q, s, r) {
                        var t, u = window.gnTestSvr ? window.gnTestSvr : "";
                        t = a.evalValue(s || "{}");
    ...
    ; function b(e) {
        return {
            uploadInChip: function (f) {
                ...
                a.QMAjax.send(['/cgi-bin/uploadunite?func=CreateFile&&inputf=json&outputf=json&&sid=', a.getSid()].join(""), {
                    method: 'post', headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, content: a.T('{"path":"$path$","appid":"$appid$","size":$size$,"md5":"$md5$","sha":"$sha$","sha3":"$sha3$"}').replace({ appid: f.get("nAppId"), path: encodeURIComponent(f.get("sName")), size: f.get("nSize"), md5: f.get("sMD5"), sha: f.get("sSHA"), sha3: f.get("sSHA3") }), onload: function (j, l, k) {
                        var n = a.evalValue(l || "{}");
                ...
                function h() {
                    ...
                    a.QMAjax.send(k, {
                        method: "GET", headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, onload: function (l, n, m) {
                            var o = a.evalValue(n || "{}");
                            if (l && o && o.errcode == "0") {
                                f.set(o.data);
                ...
                if (!g._nUpFileSizeTime) {
                    ...
                    a.QMAjax.send(a.T("/cgi-bin/ftnUpFileSize?sid=$sid$&filekey=$fileid$&uploadsize=$uploadsize$&ef=js").replace({ sid: a.getSid(), fileid: g.get("sFileId"), uploadsize: g.get("nUploadedSize") }), {
                        method: "GET", headers: { "If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0" }, onload: function (k, m, l) {
        ...
        return a.extend(c(k), j.getH5SafeLib(k), {
            init_: function (n) {
                ...
                s.insertFlashElem_(a.extend({
                    oWin: t, oFlashDOMCfg: { nHeight: '1px', nWidth: '1px', nTop: "-9999px", nLeft: "-9999px" }, insertHTML: function (u) {
                        n.innerHTML = u;
                    }, onerror: function () {
    ...
    ; (function (d) {
        ...
        function k(w) {
            ...
            return d.extend(m.getChipLib(w), m.getH5SafeLib(w), {
                nConcurrent: q, nReaderNum: 2, nHashWorkNum: r, nMaxRetryNum: 100, nMaxSingleRetryNum: 3, nSignFileBlockSize: 512 * 1024, nUploadFileBlockSize: 512 * 1024, nCacheThreshold: 1, init_: function () {
